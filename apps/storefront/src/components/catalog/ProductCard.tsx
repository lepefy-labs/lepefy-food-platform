...
export function ProductCard({ product, variant = 'grid' }: ProductCardProps) {
  ...
  return (
    <Link
      ...
      className={
        variant === 'grid'
          ? 'group block rounded-lg overflow-hidden border border-gray-200 hover:border-gray-300 transition-all hover:shadow-card'
          : 'group relative block flex-shrink-0 w-36 md:w-full md:flex-shrink rounded-lg overflow-hidden border border-gray-100 bg-white'
      }
    >
