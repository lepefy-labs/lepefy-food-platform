...
export async function GET() {
  ...
  if (!eligible && referral.referral_availability_mode === 'SPENDING_THRESHOLD') {
    ...
    response.progress = { currentSpend, threshold: referral.referral_unlock_spending_threshold };
  }
