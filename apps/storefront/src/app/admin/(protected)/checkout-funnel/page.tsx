...
import { IconArrowLeft, IconArrowUpRight, IconCheck, IconClock, IconRefresh, IconShoppingCart, IconX } from '@tabler/icons-react';
...
export default async function CheckoutFunnelPage() {
  ...
  const cards = [
    ...
    { label: 'À finaliser', value: funnel.checkout_open, helper: 'Encore récupérables', icon: IconClock },
    { label: 'Repris', value: funnel.checkout_resumed, helper: `Recovery ${recoveryConversion}`, icon: IconRefresh },
    { label: 'Expirés', value: funnel.checkout_expired, helper: 'Non finalisés sous 24 h', icon: IconX },
  ...
  return (
    <div className="mx-auto w-full max-w-6xl pb-10">
      ...
      <AdminPageHeader
        ...
        description="Mesurez la conversion, les abandons et la récupération des achats non finalisés."
        meta="30 jours"
      />
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-2">
        ...
        <section className="rounded-2xl border border-[var(--admin-border)] bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-400">
            Un checkout « à finaliser » n&apos;est pas une commande. Le stock n&apos;est pas réservé et l&apos;achat doit encore être confirmé par le paiement. Les sessions expirées restent conservées pour mesurer l&apos;abandon sans polluer les opérations de commandes.
          </p>
        </section>
      </div>
    </div>
