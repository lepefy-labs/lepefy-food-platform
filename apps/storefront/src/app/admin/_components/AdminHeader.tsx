...
export default function AdminHeader({ platformName, platformLogoUrl, tenantName, categories, workspace, shopAdminUrl, eventsAdminUrl, isPlatformOwner = false, permissions = [], adminEmail, adminDisplayName, pendingPaymentsCount = 0, pendingEventRequestsCount = 0, pendingRentalRequestsCount = 0, newInquiriesCount = 0 }: AdminHeaderProps) {
