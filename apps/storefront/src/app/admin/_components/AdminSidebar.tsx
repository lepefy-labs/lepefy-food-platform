    ...
    <nav className="flex h-full flex-col pb-3">
      {workspace === 'shop' ? (
        ...
        <>
          ...
          <Link href="/admin/evenementiel/evenements" className={linkClass(pathname.startsWith('/admin/evenementiel/evenements'))}><IconCalendarEvent size={20} />Événements</Link>
          <Link href="/admin/evenementiel/reservations" className={linkClass(pathname.startsWith('/admin/evenementiel/reservations') || pathname.startsWith('/admin/evenementiel/paiements-en-attente'))}><IconFileInvoice size={20} /><span className="flex-1">Réservations / Paiements</span>{pendingEventRequestsCount > 0 && <span className="rounded-full bg-amber-100 px-1.5 py-0.5 text-xs font-semibold text-amber-800">{pendingEventRequestsCount}</span>}</Link>
      ...
      {isPlatformOwner && (
        <>
          ...
          <Link href="/admin/platform" className={linkClass(pathname === '/admin/platform')}><IconSettings size={20} />Console plateforme</Link>
