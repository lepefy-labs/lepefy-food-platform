...
export default function AdminSidebar({
  ...
  return (
    <nav className="flex h-full flex-col">
      ...
      <Link href="/admin" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin')}`}>
      ...
      <Link
        ...
        className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname.startsWith('/admin/catalogue'))}`}
      >
      ...
      <Link href="/admin/accueil-slides" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/accueil-slides')}`}><IconPhoto size={20} stroke={1.5} />Slides d&apos;accueil</Link>
      <Link href="/admin/loyalty" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/loyalty')}`}><IconGift size={20} stroke={1.5} />Fidélité &amp; parrainage</Link>
      <Link href="/admin/loyalty/scan" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/loyalty/scan')}`}><IconScan size={20} stroke={1.5} />Scan fidélité</Link>
      <Link href="/admin/livraison" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/livraison')}`}><IconTruck size={20} stroke={1.5} />Livraison</Link>

      <button onClick={() => setEvenementielOpen(!evenementielOpen)} className={`mx-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-colors ${navClass(pathname.startsWith('/admin/evenementiel'))}`}>
      ...
      <Link href="/admin/ambassadeurs" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/ambassadeurs')}`}><IconStar size={20} stroke={1.5} />Ambassadeurs</Link>

      <button onClick={() => setParametresOpen(!parametresOpen)} className={`mx-1 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm transition-colors ${navClass(pathname.startsWith('/admin/parametres'))}`}>
      ...
      <Link href="/admin/ai-lab" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/ai-lab')}`}><IconSparkles size={20} stroke={1.5} />IA — Base de connaissance</Link>
      <p className="mb-2 mt-5 px-3 text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Compte</p>
      <Link href="/admin/billing" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/billing')}`}><IconCreditCard size={20} stroke={1.5} />Abonnement</Link>

      {isPlatformOwner && (
        <>
          <p className="mb-2 mt-5 px-3 text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Plateforme</p>
          <Link href="/admin/team" className={`mx-1 flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${navClass(pathname === '/admin/team')}`}><IconUsers size={20} stroke={1.5} />Équipe</Link>
        </>
      )}
    </nav>
  );
