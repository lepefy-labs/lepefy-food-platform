...
const tableData: Order[] = [
  {
    id: 1,
    user: {
      image: '/_tailadmin-staging/images/user/user-02.jpg',
      name: 'Lindsey Curtis',
      role: 'Web Designer',
    },
    ...
    team: {
      images: [
        '/_tailadmin-staging/images/user/user-03.jpg',
        '/_tailadmin-staging/images/user/user-04.jpg',
        '/_tailadmin-staging/images/user/user-05.jpg',
      ],
    },
    budget: '3.9K',
    status: 'Active',
  },
  {
    id: 2,
    user: {
      image: '/_tailadmin-staging/images/user/user-03.jpg',
      name: 'Kaiya George',
      role: 'Project Manager',
    },
    projectName: 'Technology',
    team: {
      images: ['/_tailadmin-staging/images/user/user-04.jpg', '/_tailadmin-staging/images/user/user-05.jpg'],
    },
    budget: '24.9K',
    status: 'Pending',
  },
  {
    ...
    team: {
      images: ['/_tailadmin-staging/images/user/user-04.jpg'],
    },
    budget: '12.7K',
    status: 'Active',
  },
  {
    id: 4,
    user: {
      image: '/_tailadmin-staging/images/user/user-04.jpg',
    ...
    team: {
      images: [
        '/_tailadmin-staging/images/user/user-05.jpg',
        '/_tailadmin-staging/images/user/user-02.jpg',
        '/_tailadmin-staging/images/user/user-03.jpg',
      ],
    },
    budget: '2.8K',
  ...
  },
  {
    id: 5,
    user: {
      image: '/_tailadmin-staging/images/user/user-05.jpg',
      name: 'Carla George',
