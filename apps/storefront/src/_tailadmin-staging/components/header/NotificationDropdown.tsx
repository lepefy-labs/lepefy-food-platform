...
const notifications = [
  { name: 'Terry Franci', avatar: 'user-02.jpg', dot: 'success', time: '5 min ago' },
  { name: 'Alena Franci', avatar: 'user-03.jpg', dot: 'success', time: '8 min ago' },
  { name: 'Jocelyn Kenter', avatar: 'user-04.jpg', dot: 'success', time: '15 min ago' },
  { name: 'Brandon Philips', avatar: 'user-05.jpg', dot: 'error', time: '1 hr ago' },
] as const;
              ...
              >
                <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                  <Image
                    width={40}
                    height={40}
                    src={`/_tailadmin-staging/images/user/${n.avatar}`}
                    alt="User"
                  ...
                  <span
                    className={`absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900 ${
                      n.dot === 'success' ? 'bg-success-500' : 'bg-error-500'
                    }`}
                  ></span>
                </span>
