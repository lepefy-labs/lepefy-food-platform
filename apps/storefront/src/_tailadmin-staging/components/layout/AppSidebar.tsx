...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: 'Dashboard',
    subItems: [{ name: 'Ecommerce', path: '/admin/_staging-preview', pro: false }],
  },
  {
    icon: <CalenderIcon />,
    name: 'Calendar',
  ...
  return (
    ...
    >
      <div className={`py-8 flex  ${!isExpanded && !isHovered ? 'lg:justify-center' : 'justify-start'}`}>
        <Link href="/admin/_staging-preview">
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <Image
                className="dark:hidden"
                src="/_tailadmin-staging/images/logo/logo.svg"
                alt="Logo"
                width={150}
                height={40}
              />
              <Image
                ...
                src="/_tailadmin-staging/images/logo/logo-dark.svg"
                alt="Logo"
                width={150}
                height={40}
              />
            ...
            <Image src="/_tailadmin-staging/images/logo/logo-icon.svg" alt="Logo" width={32} height={32} />
          )}
        </Link>
      </div>
