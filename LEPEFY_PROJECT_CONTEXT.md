...
*Lepefy Labs — Lepefy Food Platform — Context document v3.20 — 3 Agosto 2026 (base: v3.19; verifica di coerenza contro filesystem/git reale — i cinque cicli di v3.19 risultano tutti eseguiti tranne la pianificazione Play Store [confermata solo-analisi], 17 commit non ancora mergiati su `main`, `pnpm typecheck` pulito verificato in sessione — vedi §38 per il dettaglio completo)*
