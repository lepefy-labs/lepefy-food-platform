...
*Lepefy Labs — Lepefy Food Platform — Context document v3.21 — 6 Agosto 2026 (base: v3.20; due cicli 5–6/08 integrati — Play Store TWA in gran parte eseguito [resta il gate Closed Testing 12 tester/14gg] + smart-link QR negozio `/go` eseguito — **solo da chat, nessuna verifica contro filesystem/git in questa sessione, da riconfermare alla prossima passata di coerenza** — vedi §39 per il dettaglio completo)*
