...
**Base audit:** `main + Shipping Intelligence V1A–V1D + tenant-admin immediate campaign tick`; `main + verified service reviews V1 + loyalty Wallet issuance + compact review submission UI`
