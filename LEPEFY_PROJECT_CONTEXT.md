...
*Lepefy Labs — Lepefy Food Platform — Context document v3.18 — 31 Luglio 2026 (base: v3.17; verifica di coerenza contro filesystem/git reale — numerazione migration corretta (`039`→`040` per il loyalty, `039_admin_users.sql` aggiunta), confermato che gran parte del ciclo 31/07 è già su `main` tranne `/orders` e la pre-compilazione checkout — vedi §9bis e §36 per il dettaglio completo)*
