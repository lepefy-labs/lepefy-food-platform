...
*Lepefy Labs — Lepefy Food Platform — Context document v3.45 — 18 Agosto 2026 (base: v3.44; deferred PaymentIntent creation su tutti e 4 i moduli, componente/hook Stripe condivisi in `lib/payments/` e `components/payments/`, supporto multi-account Stripe per modulo con fallback totale sulle variabili globali — vedi §63 per il dettaglio completo)*
